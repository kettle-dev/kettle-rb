...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/kettle/rb/version.rb", mod) }::Kettle::Rb::Version::VERSION
  else
    # NOTE: Use __FILE__ or __dir__ until removal of Ruby 1.x support
    # __dir__ introduced in Ruby 1.9.1
    lib = File.expand_path("lib", File.dirname(__FILE__))
    $LOAD_PATH.unshift(lib) unless $LOAD_PATH.include?(lib)
    require "kettle/rb/version"
    Kettle::Rb::Version::VERSION
  end
...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency("kettle-test", "~> 2.0", ">= 2.0.16")            # ruby >= 2.4.0
