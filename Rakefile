...
# kettle-rb Rakefile v7.1.28 - 2026-09-10
...
# rake install                                # Build and install kettle-rb-1.0.0.gem in...
# rake install:local                          # Build and install kettle-rb-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template kettle-rb against itse...
