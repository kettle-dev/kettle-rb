...
`kettle-dev` is the small shared Ruby library for the kettle-dev toolchain.
...
`kettle-dev` has no runtime configuration. The compatibility matrix is packaged
...
[kettle-readme-backers]: https://github.com/kettle-dev/kettle-dev/blob/main/bin/kettle-readme-backers
...
[🚎15-🪪-wf]: https://github.com/kettle-dev/kettle-dev/actions/workflows/license-eye.yml
[🚎15-🪪-wfi]: https://github.com/kettle-dev/kettle-dev/actions/workflows/license-eye.yml/badge.svg
